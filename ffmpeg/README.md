...
ffmpeg -re -i big_buck_bunny_1080p_h264.mov -c:v mpeg4 -vtag xvid -b:v 5000k -an -f rtp rtp://127.0.0.1:5600 -sdp_file
stream.sdp

# take part of the video (4' to 30')
ffmpeg -re -ss 4 -t 30 -i big_buck_bunny_1080p_h264.mov -c:v mpeg4 -vtag xvid -b:v 5000k -an -f rtp rtp://127.0.0.1:5600 -sdp_file stream.sdp
